...
(function(dice) {
    ...
    this.standart_d20_dice_face_labels = [' ', '0', 'X', '3', '4', '5', '6', '1', '2', '3',
            '4', '5', '6', '1', '2', '3', '4', '5', '6', '1', '2', 'ß'];
    ...
    function get_dice_value(dice) {
        ...
        var matindex = (closest_face.materialIndex % 6);
        console.log(closest_face.materialIndex);
        if (matindex == 0) {
            matindex = 6;
        } else if (closest_face.materialIndex == 21) {
            matindex = 7;
        } else if (closest_face.materialIndex == 2) {
            matindex = 8;
        }
